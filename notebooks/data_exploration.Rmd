...
get_provider_specialty <- function(provider) {
  ...
  case_when(
  #   # provider$taxonomy_classification == "Anesthesiology" ~ paste0("Anesthesiology|", provider$taxonomy_specialization),
  #   # provider$taxonomy_classification == "Dermatology" ~ "Dermatology",
  #   # provider$taxonomy_classification == "Nurse Practitioner" ~ paste0("Nurse Practitioner|", provider$taxonomy_display_name),
  #   # provider$taxonomy_classification == "Internal Medicine" & str_detect(provider$taxonomy_specialization, "Cardiac|Cardio") ~ paste0("Cardiology|", provider$taxonomy_specialization),
  #   # provider$taxonomy_classification == "Internal Medicine" & str_detect(provider$taxonomy_specialization, "Hematology|Oncology") ~ paste0("Hematology/Oncology|", provider$taxonomy_specialization),
  #   # provider$taxonomy_classification == "Radiology" ~ paste0("Radiology|", provider$taxonomy_specialization),
  #   # provider$taxonomy_classification == "Nuclear Medicine" ~ "Radiology|Nuclear Medicine",
...
get_facility_affiliation <- function(facility) {
  ...
  case_when(
    ...
    str_detect(org_name, ascension) ~ "ASCENSION",
...
hop_teaming_provider_to_facility_patient_counts <- hop_teaming_provider_to_facility %>% 
  inner_join(hop_teaming_providers %>% rename_with(~paste0("from_", .x)), by = "from_npi") %>%
